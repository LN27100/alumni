...
<body>
    ...
    <div class="parallax parallax1" id="adhérents">
        ...
        <div class="container">
            <div class="row">
                ...
                $indice_debut = ($page - 1) * $elements_par_page;

                for ($i = $indice_debut; $i < min($indice_debut + $elements_par_page, count($data)); $i++) {
                    $item = $data[$i];
                    // Utilisation de la variable $nb pour obtenir des images différentes pour chaque carte
                    $nb = $i + 1;
                ...
                <div class="pagination d-flex justify-content-center">
                    <?php
                    for ($p = 1; $p <= ceil(count($data) / $elements_par_page); $p++) {
    ...
    <div class="transit">Contactez vos anciens camarades et organisez des retrouvailles ! Les réunions d'anciens élèves sont affichées dans l'agenda de la communauté. N'hésitez pas à vous inscrire à l'une d'entre elles pour y revoir vos collègues de formations mais aussi vos formateurs ! </div>
